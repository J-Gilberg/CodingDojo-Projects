        ...
        <div>
            <div>
                ...
                <form onSubmit={onSubmitHandlerReg}>
                    ...
                    <span>{regErrors.password ? regErrors.password.message : ''}</span>
